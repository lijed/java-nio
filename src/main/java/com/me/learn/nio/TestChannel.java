...
public class TestChannel {
    ...
    public void test1() {
        ...
        try {
            fis = new FileInputStream("d:/niotest/mysq.pdf");
            fos = new FileOutputStream("d:/niotest/mysq2.pdf");
    ...
    public void test2() {
        ...
        FileChannel outChannel = null;
        try {
            inChannel = FileChannel.open(Paths.get("d:/niotest/mysq.pdf"), StandardOpenOption.READ);
            outChannel = FileChannel.open(Paths.get("d:/niotest/mysq2.pdf"), StandardOpenOption.WRITE, StandardOpenOption.READ, StandardOpenOption.CREATE);
    ...
    public void test4() {
        ...
        try {
            raf1 = new RandomAccessFile("d:/niotest/1.txt", "rw");
